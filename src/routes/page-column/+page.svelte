<script>
  ...
  const all_posts = import.meta.glob(`../../assets/markdown/page-column/**/*`, { eager: true });
...
<!-- <Row>
  <Column50>
    <Card color="warning-dark">
      <p>Reversed On Mobile 1/2</p>
    </Card>
  </Column50>

  <Column50>
    <Card color="warning-light">
      <p>Reversed On Mobile 2/2</p>
    </Card>
  </Column50>
</Row> -->
<style>
